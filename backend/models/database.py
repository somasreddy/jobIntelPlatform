...
async def log_audit_event(
    ...
    Colocated with the AuditLog model (rather than in a separate service
    module) so it's a single, obvious import for any endpoint that wants to
    start emitting audit events: `from models.database import
